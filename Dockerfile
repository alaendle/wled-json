...
# Cache compiler
RUN stack install stylish-haskell hlint weeder --resolver=lts-24.46 --system-ghc --allow-newer && \
...
# Do the actual work
COPY . .
RUN stack test --system-ghc --ghc-options '-Werror -Weverything -Wno-missing-safe-haskell-mode -Wno-implicit-prelude -Wno-missing-role-annotations -Wno-safe -Wno-unsafe -Wno-prepositive-qualified-module -Wno-missing-import-lists'
